...
const BehaviorScript bhvReisalinaFS[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_LONG(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    BEGIN_LOOP(),
        SET_INT(oIntangibleTimer, 0),
        CALL_NATIVE(beh_reisalina_fs),
    END_LOOP(),
};
...
const BehaviorScript bhvCustomCam[] = {
    BEGIN(OBJ_LIST_DEFAULT),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    CALL_NATIVE(bhv_custom_cam_init),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_custom_cam_loop),
    END_LOOP(),
};

const BehaviorScript bhvCustomCamFocus[] = {
    BEGIN(OBJ_LIST_DEFAULT),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_custom_cam_focus_loop),
    END_LOOP(),
};

const BehaviorScript bhvCustomCamNextPos[] = {
    BEGIN(OBJ_LIST_DEFAULT),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    BEGIN_LOOP(),
        //CALL_NATIVE(bhv_custom_cam_focus_loop),
...
const BehaviorScript bhvCustomCamApproachPos[] = {
    BEGIN(OBJ_LIST_DEFAULT),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    BEGIN_LOOP(),
        //CALL_NATIVE(bhv_custom_cam_focus_loop),
...
const BehaviorScript bhvCustomCamFocusApproachPos[] = {
    BEGIN(OBJ_LIST_DEFAULT),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    BEGIN_LOOP(),
        //CALL_NATIVE(bhv_custom_cam_focus_loop),
...
const BehaviorScript bhvCustomCamVolume[] = {
    BEGIN(OBJ_LIST_DEFAULT),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_custom_cam_volume_loop),
    END_LOOP(),
};

const BehaviorScript bhvCustomCamVolumeCamPos[] = {
    BEGIN(OBJ_LIST_DEFAULT),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_custom_cam_volume_cam_loop),
    END_LOOP(),
};

const BehaviorScript bhvCustomCamVolumeCamFocus[] = {
    BEGIN(OBJ_LIST_DEFAULT),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_custom_cam_volume_focus_loop),
    END_LOOP(),
};

const BehaviorScript bhvIntroCutscene[] = {
    BEGIN(OBJ_LIST_DEFAULT),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_intro_cutscene_loop),
    END_LOOP(),
};

const BehaviorScript bhvGenericCutsceneObject[] = {
    BEGIN(OBJ_LIST_DEFAULT),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    LOAD_ANIMATIONS(oAnimations, intro_mario_anims),
    ANIMATE(0),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_intro_generic_object_loop),
    END_LOOP(),
};

const BehaviorScript bhvSwitchCaseModel[] = {
    BEGIN(OBJ_LIST_DEFAULT),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    CALL_NATIVE(bhv_switch_animation_init),
    //LOAD_ANIMATIONS(oAnimations, daisuka_sil_anims),
    //ANIMATE(0),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_switch_animation_loop),
    END_LOOP(),
};

const BehaviorScript bhvGeofrontElevator[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_LONG(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_UCODE_LARGE)),
    LOAD_COLLISION_DATA(geofront_elevator_collision),
    DROP_TO_FLOOR(),
    BEGIN_LOOP(),
