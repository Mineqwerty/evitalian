...
const LevelScript level_main_scripts_entry[] = {
   ...
   // LOAD_MODEL_FROM_GEO(MODEL_BOWSER_KEY_CUTSCENE,     bowser_key_cutscene_geo),
    ...
    LOAD_MODEL_FROM_GEO(MODEL_PEASATO,                 peasato_geo),
    LOAD_MODEL_FROM_GEO(MODEL_LUIJI,                 luiji_geo),
    LOAD_MODEL_FROM_GEO(MODEL_REISALINA,                 reisalina_geo),
    LOAD_MODEL_FROM_GEO(MODEL_LUIJI_FIXED,                 luiji_fixed_geo),
    LOAD_MODEL_FROM_GEO(MODEL_E_GENDDO,                 e_genddo_geo),
    LOAD_MODEL_FROM_GEO(MODEL_EVI_UNIT,                 evi_unit_geo),
    LOAD_MODEL_FROM_GEO(MODEL_SACHIEL,             sachiel_geo),
    LOAD_MODEL_FROM_GEO(MODEL_AT_FIELD,             at_field_geo),
    LOAD_MODEL_FROM_GEO(MODEL_DAISUKA,             daisuka_geo),
    FREE_LEVEL_POOL(),
