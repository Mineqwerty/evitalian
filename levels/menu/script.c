...
const LevelScript level_main_menu_entry_file_select[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_MAIN_MENU_YELLOW_FILE_BUTTON,     fmttm_geo),
    ...
    LOAD_MODEL_FROM_GEO(MODEL_FMTTM,         reisalina_sil_fs_geo),
    ...
    AREA(/*index*/ 1, geo_menu_file_select_strings_and_menu_cursor),
        ...
        OBJECT(/*model*/ MODEL_FMTTM, /*pos*/ 8000, -4000, -19000, /*angle*/ 0, 0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvReisalinaFS),
