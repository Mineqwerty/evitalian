...
const LevelScript level_jrb_entry[] = {
	...
	AREA(1, jrb_area_1),
		...
		WARP_NODE(0x0B, LEVEL_WF, 0x04, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_DAISUKA, 79, 2131, 1931, 0, -65, 0, 0x00160000, bhvGenericNPC),
		OBJECT(MODEL_NONE, 0, 200, 0, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		MARIO_POS(0x01, 0, 0, 200, 0),
		OBJECT(MODEL_NONE, 816, 2131, 1805, 0, 0, 0, 0x200B0000, bhvWarp),
