...
const GeoLayout bob_area_2_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_TRANSPARENT, 28, 100, -19701, bob_dl_Plane_mesh_layer_5),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
		...
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				...
				GEO_OPEN_NODE(),
					...
					GEO_TRANSLATE_NODE_WITH_DL(LAYER_FORCE, 0, 0, 0, bob_backdrop_Plane_029_mesh),
