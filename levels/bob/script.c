...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		OBJECT(MODEL_NONE, -2050, 0, 37, 0, 0, 0, 0x300B0000, bhvWarp),
	...
	AREA(2, bob_area_2),
		...
		OBJECT(MODEL_AMP, -83, 5295, -19792, 0, 0, 0, (3 << 16), bhvCirclingAmp),
		OBJECT(MODEL_AMP, 162, 4774, -18701, 0, 0, 0, (3 << 16), bhvCirclingAmp),
		OBJECT(MODEL_AMP, -246, 4774, -18701, 0, 0, 0, (3 << 16), bhvCirclingAmp),
		OBJECT(MODEL_AMP, 145, 4284, -17593, 0, 0, 0, (3 << 16), bhvCirclingAmp),
		OBJECT(MODEL_AMP, -47, 4293, -17593, 0, 0, 0, (3 << 16), bhvCirclingAmp),
		OBJECT(MODEL_AMP, -47, 3856, -16548, 0, 0, 0, (3 << 16), bhvCirclingAmp),
		OBJECT(MODEL_AMP, 254, 3841, -16548, 0, 0, 0, (3 << 16), bhvCirclingAmp),
		...
		OBJECT(MODEL_AMP, -13, 4827, -18506, 0, 0, 0, (3 << 16), bhvCirclingAmp),
		OBJECT(MODEL_AMP, -225, 4350, -17488, 0, 0, 0, (3 << 16), bhvCirclingAmp),
		OBJECT(MODEL_AMP, 76, 3690, -16050, 0, 0, 0, (3 << 16), bhvCirclingAmp),
