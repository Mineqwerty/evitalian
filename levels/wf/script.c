...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		OBJECT(MODEL_NONE, 6231, 2399, 6296, 0, 0, 0, (1 << 16), bhvCustomCamVolumeCamPos),
		...
		OBJECT(MODEL_NONE, -6998, 100, -87, 0, 0, 0, 0x300C0000, bhvWarp),
		OBJECT(MODEL_NONE, 5354, 2388, 4550, 0, 0, 0, 0x010F0000, bhvCustomCamVolume),
	...
	AREA(2, wf_area_2),
		...
		OBJECT(MODEL_NONE, 3667, 1158, -20, 0, 0, 0, 0x200D0000, bhvSpinAirborneWarp),
	...
	AREA(5, wf_area_5),
		...
		WARP_NODE(0xF0, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF1, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0x0B, LEVEL_WF, 0x06, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_NONE, 165, 533, 1984, 0, 0, 0, 0x00000000, bhvCustomCam),
		OBJECT(MODEL_NONE, 1502, 710, 2079, 0, 0, 0, 0x00000000, bhvCustomCamFocus),
