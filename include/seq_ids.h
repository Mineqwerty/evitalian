...
enum SeqId {
    ...
    SEQ_STREAMED_CRUEL_ANGELS_THESIS,
    SEQ_STREAMED_FLY_ME_TO_THE_MOON,
    SEQ_STREAMED_TRIUMPHANT,
    SEQ_STREAMED_DECISIVE,
    SEQ_STREAMED_ODE,
    SEQ_STREAMED_AIR,
    SEQ_STREAMED_THANATOS,
    SEQ_STREAMED_KOMM_SUSSER_TOD,
    SEQ_COUNT
};
