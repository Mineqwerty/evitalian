...
//custom camn caniel
#define /*0x0F4*/ oObjCamFocus                              OBJECT_FIELD_OBJ(0x1B)
#define /*0x0F4*/ oCutsceneIndex                              OBJECT_FIELD_S32(0x1C)
#define /*0x0F4*/ oObjCamApproach                              OBJECT_FIELD_OBJ(0x1D)
#define /*0x0F4*/ oFramesLeftOnApproach                              OBJECT_FIELD_S32(0x1E)

//cam focus
#define /*0x0F4*/ oFocusCutsceneIndex                              OBJECT_FIELD_S32(0x1B)

//intro cutscene
#define /*0x0F4*/ oFramesLeftOnApproach2                              OBJECT_FIELD_S32(0x1B)
#define /*0x0F4*/ oObjCutscene1                              OBJECT_FIELD_OBJ(0x1C)
