...
extern const BehaviorScript bhvReisalinaFS[];
...
extern const BehaviorScript bhvCustomCam[];
extern const BehaviorScript bhvCustomCamFocus[];
extern const BehaviorScript bhvCustomCamNextPos[];
extern const BehaviorScript bhvCustomCamApproachPos[];
extern const BehaviorScript bhvCustomCamFocusApproachPos[];
extern const BehaviorScript bhvIntroCutscene[];
extern const BehaviorScript bhvGenericCutsceneObject[];
extern const BehaviorScript bhvSwitchCaseModel[];
extern const BehaviorScript bhvGeofrontElevator[];
