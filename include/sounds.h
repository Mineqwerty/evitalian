...
#define SOUND_LUIGI_HURT                /* 0x045F8080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,   0x76, 0x80, SOUND_DISCRETE)
#define SOUND_CROSS                /* 0x045F8080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,   0x77, 0x80, SOUND_DISCRETE)
#define SOUND_AT_FIELD                /* 0x045F8080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,   0x78, 0x80, SOUND_DISCRETE)
#define SOUND_RAMIEL_HURT                /* 0x045F8080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,   0x79, 0x80, SOUND_DISCRETE)
#define SOUND_RAMIEL_BEAM                /* 0x045F8080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,   0x7A, 0x80, SOUND_DISCRETE)
#define SOUND_RAMIEL_IDLE                /* 0x045F8080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,   0x7B, 0x80, SOUND_DISCRETE)
#define SOUND_EVI_BITE                /* 0x045F8080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,   0x7C, 0x80, SOUND_DISCRETE)
#define SOUND_SCREAMING                /* 0x045F8080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,   0x7D, 0x80, SOUND_DISCRETE)
