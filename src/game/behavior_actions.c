...
#include "behaviors/custom_cam.inc.c"
#include "behaviors/intro_cutscene.inc.c"
#include "behaviors/geofront_elevator.inc.c"
#include "behaviors/npc.inc.c"
#include "behaviors/game_cutscenes.inc.c"
#include "behaviors/evi_unit.inc.c"
